...
uint8_t inflow_sensor_addr[8] = {0x28, 0xFF, 0x64, 0x02, 0xE3, 0x8B, 0xDC, 0x9A};
uint8_t outflow_sensor_addr[8] = {0x28, 0xFF, 0x64, 0x02, 0xE7, 0x25, 0x43, 0x66};
